...
parser = argparse.ArgumentParser(description='CROnlyPostFit plot commands')
...
m.InputDirectory = WORKING_DIR+'/rootfiles/'+dataset+"/CROnlyPostFit/"
if args.Year<0:
...
m.OutputDirectory = ENV_PLOT_PATH+"/"+dataset+"/CROnlyPostFit/"+str_Year+"/"
...
tl.DrawLatex(0.2, 0.815, 'CR-only postfit')
'''
