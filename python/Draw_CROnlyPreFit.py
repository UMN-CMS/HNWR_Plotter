...
parser = argparse.ArgumentParser(description='CROnlyPreFit plot commands')
...
m.InputDirectory = WORKING_DIR+'/rootfiles/'+dataset+"/CROnlyPreFit/"
if args.Year<0:
...
m.OutputDirectory = ENV_PLOT_PATH+"/"+dataset+"/CROnlyPreFit/"+str_Year+"/"
...
tl.DrawLatex(0.2, 0.815, 'CR-only prefit')
'''
