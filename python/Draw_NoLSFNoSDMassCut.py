...
m.InputDirectory = WORKING_DIR+'/rootfiles/'+dataset+"/NoLSFNoSDMassCut/"
...
m.OutputDirectory = ENV_PLOT_PATH+"/"+dataset+"/NoLSFNoSDMassCut/"+str_Year+"/"
if args.ApplyZPtRwg:
  m.OutputDirectory = ENV_PLOT_PATH+"/"+dataset+"/NoLSFNoSDMassCut/"+str_Year+"/ApplyZPtRwg/"
