...
*/
      ...
      TH1D *hist_Boosted = (TH1D *)file_Full->Get("HNWRNoHoverE_"+channel+"_Boosted/NEvent_HNWRNoHoverE_"+channel+"_Boosted");
      TH1D *hist_Boosted_TwoLepton = (TH1D *)file_Full->Get("HNWRNoHoverE_"+channel+"_Boosted_TwoLepton/NEvent_HNWRNoHoverE_"+channel+"_Boosted_TwoLepton");

      cout << samplealias << "\t" << hist_Boosted_TwoLepton->GetEntries()/hist_Boosted->GetEntries() << endl;
