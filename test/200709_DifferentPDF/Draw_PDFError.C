...
void Draw_PDFError(int Year, TString PDFName){
  ...
  TString base_filepath = "/data6/Users/jskim/SKFlatOutput/Run2Legacy_v4/HNWRAnalyzer/2016/RunSyst__Signal__SignalMuonOnly__RunXsecSyst__RunNewPDF__"+PDFName+"__/";
  TString base_plotpath = ENV_PLOT_PATH+"/"+dataset+"/temp/200709_DifferentPDF//"+TString::Itoa(Year,10)+"/"+PDFName+"/";
